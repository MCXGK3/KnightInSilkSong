...
4. NEW To adjust the status of the knight you can now also use hotkeys (configurable with BeplnEx). For health or naildamage please refresh by switching back and forth to Hornet to update the knight's status and register the changes in health or naildamage .\
